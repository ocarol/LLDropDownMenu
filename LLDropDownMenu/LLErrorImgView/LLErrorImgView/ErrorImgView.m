...
+ (void)showErrorImageViewWithTitle:(NSString *)title Image:(UIImage *)image onView:(UIView *)view {
    [self showErrorImageViewWithTitle:title Image:image onView:view errorLabelColor:ColorI(0xa8a8a8) labelFont:nil];
}
...
+ (void)showErrorImageViewWithTitle:(NSString *)title Image:(UIImage *)image onView:(UIView *)view errorLabelColor:(UIColor *)errorLabelColor labelFont:(UIFont *)labelFont {
    ...
    if(errorLabelColor) erroViewImageview.errorLabel.textColor = errorLabelColor;
    if(labelFont) erroViewImageview.errorLabel.font = labelFont;
...
- (void)showErrorImageViewWithEnum:(errorImgViewEnum)errorImgViewEnum onView:(UIView *)view {
    self.errorLabel.textColor = ColorI(0xa8a8a8);
    self.size = CGSizeMakeCustom(100, 100);
